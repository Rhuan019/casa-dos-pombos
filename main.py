...
pombo_img = pg.image.load(cwd + '\imgs\pombo.png')
house_img = pg.image.load(cwd + '\imgs\casa.png')

plus_img = pg.image.load(cwd + '\imgs\plus.png')
plus_img=pg.transform.scale(plus_img, (40,40))
minus_img = pg.image.load(cwd + '\imgs\minus.png')
minus_img=pg.transform.scale(minus_img, (40,40))

plus_img_press = pg.image.load(cwd + '\imgs\plus_press.png')
plus_img_press=pg.transform.scale(plus_img_press, (40,40))
minus_img_press = pg.image.load(cwd + '\imgs\minus_press.png')
